   ...
   */
    ...
    private class ProgressDialog extends Dialog {
        ...
        private void initViews() {
            ...
            mLabelText = (TextView) findViewById(com.krb.kprogresshud.R.id.label);
            setLabel(mLabel, mLabelColor);
            mDetailsText = (TextView) findViewById(com.krb.kprogresshud.R.id.details_label);
